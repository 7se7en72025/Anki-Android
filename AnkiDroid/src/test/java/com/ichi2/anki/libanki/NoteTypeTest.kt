...
class NoteTypeTest : JvmTest() {
    ...
    fun test_frontSide_field() {
        ...
        val noteType = col.notetypes.get(col.defaultsForAdding().notetypeId)!!
    ...
    fun test_modelDelete() {
        ...
        col.notetypes.rem(col.notetypes.get(col.defaultsForAdding().notetypeId)!!)
    ...
    fun test_text() {
        val noteType =
            col.notetypes.get(col.defaultsForAdding().notetypeId)!!.apply {
    ...
    fun test_modelChange() {
        ...
        val basic = col.notetypes.get(col.defaultsForAdding().notetypeId)!!
        val t =
            Notetypes.newTemplate("Reverse").apply {
                qfmt = "{{Back}}"
                afmt = "{{Front}}"
